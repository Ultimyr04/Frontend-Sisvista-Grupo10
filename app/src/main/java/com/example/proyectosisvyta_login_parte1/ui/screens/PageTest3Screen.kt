...
fun PageTest3Screen(
    ...
    LaunchedEffect(Unit) {
        testViewModel.loadPreguntasRespuestas(3)
    }
    ...
    Log.d("PageTestScreen3", "IDUsuario en test: $idusuario")
                ...
                Button(
                    onClick = {
                        ...
                        idusuario?.let {
                            ...
                            testViewModel.onTestSubmit(idusuario = it, idtipotest=3)
                            testViewModel.asignarTestPuntaje(idusuario = it, idtipotest = 3)
                        }
    ...
    if(testExitoso){
        Log.d("PageTest3Screen", "Test enviado correctamente")
    }else if(errorTest != null){
        Log.e("PageTest3Screen", "Error al enviar el test: $errorTest")
    }
